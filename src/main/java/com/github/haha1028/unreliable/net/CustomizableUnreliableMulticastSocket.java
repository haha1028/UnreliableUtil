...
final class CustomizableUnreliableMulticastSocket extends MulticastSocket {
	 ...
	 *         <P>
	 *         So if you use this returned future object to call cancel(true) to cancel task, CustomizableUnreliableMulticastSocket will not be able to keep accurate lostRate or
	 *         avgDelay.
	 *         <P>
